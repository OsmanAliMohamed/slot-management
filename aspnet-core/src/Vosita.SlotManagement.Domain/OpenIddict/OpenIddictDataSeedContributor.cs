...
namespace Vosita.SlotManagement.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("SlotManagement") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "SlotManagement", DisplayName = "SlotManagement API", Resources = { "SlotManagement" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // Angular SPA Client (Resource Owner Password + Refresh Token)
        var angularClientId = configurationSection["SlotManagement_Angular:ClientId"];
        if (!angularClientId.IsNullOrWhiteSpace())
        {
            var angularRootUrl = configurationSection["SlotManagement_Angular:RootUrl"]?.TrimEnd('/');
            await CreateApplicationAsync(
                ...
                scopes: commonScopes,
                redirectUri: angularRootUrl + "/signin-oidc",
                postLogoutRedirectUri: angularRootUrl + "/signout-callback-oidc",
